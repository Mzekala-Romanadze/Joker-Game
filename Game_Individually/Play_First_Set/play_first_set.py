...
def play_first_set(original_players_order, perfect_match_scores):
    first_set_scores, perfect_match_scores = play_one_set(original_players_order, perfect_match_scores)
    ...
    if perfect_match is None:
        return players_and_first_set_scores, perfect_match_scores
    else:
        players_and_first_set_scores = final_set_scores_table(players_and_first_set_scores, perfect_match)
        return players_and_first_set_scores, perfect_match_scores
