...
def play_one_trick(players_and_cards, chosen_trump, trick_winner_player):
    ...
    for player, cards in players_and_cards.items():
        ...
        if not table_cards:
            ...
            if joker_choice == "WANT":
                joker_is_want(cards, player_cards_suits, joker_case, want_suit, chosen_trump, trump_joker_case)
